...
<body>
    <div class="form-container">
        ...
        <div class="category-id">ID: #<?php echo e($category->id); ?></div>
        ...
        <form action="<?php echo e(route('categories.update', $category->id)); ?>" method="POST">
            ...
            <div class="form-group">
                ...
                <input 
                    ...
                    value="<?php echo e(old('nome', $category->nome)); ?>"
                    required
                >
            ...
            <div class="form-group">
                ...
                ><?php echo e(old('descricao', $category->descricao)); ?></textarea>
...
<?php /**PATH /app/resources/views/categories/edit.blade.php ENDPATH**/ ?>